...
from ppo import GaussianPolicy, ValueNet, PPOBuffer, RunningNorm
...
def ppo_train(
    ...
    hidden=(64, 64),
    max_ep_len=100,
    ent_coef=0.01,         # NEW: weight for entropy bonus
    ...
    obs_rms = RunningNorm(obs_dim)   # NEW: normalizes observations
    ...
    def compute_loss_pi(data, old_logp):
        ...
        # entropy bonus is now actually added to the loss (it wasn't before)
